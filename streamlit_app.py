...
st.sidebar.markdown("Meera · Julie · Sarah · Antara · Simon · Haley")
...
# ─────────────────────────────────────────────
    ...
    with col1:
        ...
        fig1.update_layout(height=500, width=650, xaxis=dict(tickangle=45))
    ...
    with col2:
        ...
        fig2.update_layout(height=500, width=650, xaxis=dict(tickangle=45))
